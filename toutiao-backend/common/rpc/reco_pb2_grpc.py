...
from rpc import reco_pb2 as rpc_dot_reco__pb2
...
class UserRecommendStub(object):
    ...
    def __init__(self, channel):
        ...
        self.user_recommend = channel.unary_unary(
                ...
                request_serializer=rpc_dot_reco__pb2.UserRequest.SerializeToString,
                response_deserializer=rpc_dot_reco__pb2.ArticleResponse.FromString,
                )
...
def add_UserRecommendServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'user_recommend': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=rpc_dot_reco__pb2.UserRequest.FromString,
                    response_serializer=rpc_dot_reco__pb2.ArticleResponse.SerializeToString,
            ),
    }
